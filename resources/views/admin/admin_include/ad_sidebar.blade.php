<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      <li class=" nav-item"><a href="{{ url('/admin')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span><span
      ...
      <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Options</span></a>
        <ul class="menu-content">
          <li class=" nav-item"><a href="{{ route('options.create') }}"> Add new options</a></li>
          <li class=" nav-item"><a href="{{ route('options.index') }}"> List options</a></li>
        </ul>
      </li>
      <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Category</span></a>
        <ul class="menu-content">
          <li class=" nav-item"><a href="{{ route('category.create') }}"> Add new Category</a></li>
          <li class=" nav-item"><a href="{{ route('category.index') }}"> List Category</a></li>
        </ul>
      </li>
