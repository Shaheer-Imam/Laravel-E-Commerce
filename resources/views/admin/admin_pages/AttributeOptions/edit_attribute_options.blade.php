                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('options.update',$options->option_id) }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="AttributeName">Attribute</label>
                                                    <div class="col-md-9">
                                                        <select name="AttributeID" class="form-control border-primary">
                                                            <option value="1">Please Select</option>
                                                            @if (!empty($attributes))
                                                                @foreach ($attributes as $attribute)
                                                                @if ($attribute->attributes_id == $options->attributes_id)
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="OptionName">Option
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="OptionName" class="form-control border-primary"
                                                            placeholder="Option Name" name="OptionName" required value="{{$options->option_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
