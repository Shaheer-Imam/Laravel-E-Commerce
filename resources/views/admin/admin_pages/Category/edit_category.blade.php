                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('category.edit',$category->category_id)}}">Edit
                                        Category</a>
                                </li>
                            </ol>
                        </div>
                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('category.update',$category->category_id) }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        @if ($errors->any())
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="CategoryName">Category
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="CategoryName" class="form-control border-primary"
                                                            placeholder="Category Name" name="CategoryName" value="{{$category->category_name}}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="CategoryName">Parent
                                                        Category</label>
                                                    <div class="col-md-9">
                                                        <select name="ParentCategory" id="ParentCategory" class="form-control border-primary">
