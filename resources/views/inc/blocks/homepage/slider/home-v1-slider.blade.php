<div class="home-v1-slider home-slider">
	...
	<div class="slider-1 slider-2" style="background-image: url(assets/images/slider/home-v1-background.jpg);">
		<img src="/assets/images/slider/home-v1-img-2.png" alt="">
		<div class="caption">
			<div class="title">Welcome to my super store </div>
			<div class="sub-title">We welcome you to be the part of us</div>
			<div class="button">Browse now <i class="tm tm-long-arrow-right"></i></div>
			<div class="bottom-caption">Free shipping on 10000+RS order</div>
		</div>
	</div><!-- .slider-2 -->
