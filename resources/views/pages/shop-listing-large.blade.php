	...
	<div class="col-full">
		<div class="row">
			<nav class="woocommerce-breadcrumb">
				...
				<a href="{{route("shop")}}">Shop</a><span class="delimiter">
			...
			<div id="primary" class="content-area">
				<main id="main" class="site-main">
					...
					<?php @include 'inc/components/shop-listing-large-control-bar'; ?>

					<div class="tab-content">
						<div id="grid" class="tab-pane" role="tabpanel">
							<?php @include'inc/components/product-grid'; ?>
						</div><!-- .tab-pane -->

						<div id="grid-extended" class="tab-pane" role="tabpanel">
							<?php @include'inc/components/product-grid-ext'; ?>
						</div><!-- .tab-pane -->

						<div id="list-view-large" class="tab-pane active" role="tabpanel">
							<?php @include'inc/components/product-list-view-large'; ?>
						</div><!-- .tab-pane -->

						<div id="list-view" class="tab-pane" role="tabpanel">
							<?php @include'inc/components/product-list-view'; ?>
						</div><!-- .tab-pane -->

						<div id="list-view-small" class="tab-pane" role="tabpanel">
							<?php @include'inc/components/product-list-view-small'; ?>
						</div><!-- .tab-pane -->						
						
					</div><!-- .tab-content -->

					<?php @include 'inc/components/shop-control-bar-bottom'; ?>
				</main><!-- #main -->
			</div><!-- #primary -->

			<div id="secondary" class="widget-area shop-sidebar" role="complementary">
				<?php @include 'inc/components/sidebar/product-categories-widget'; ?>
				<div id="techmarket_products_filter-3" class="widget widget_techmarket_products_filter">
					<span class="gamma widget-title">Filters</span>
					<?php @include 'inc/components/sidebar/price-fliter'; ?>
					<?php @include 'inc/components/sidebar/product-filters-sidebar'; ?>
				</div>
...
<div class="col-full">
	<?php @include 'inc/blocks/homepage/recently-viewed-products'; ?>
